      ...
      <div class="inbox_msg">
        ...
        <?php if ($message['whosend']==1) { ?>
          <div class="incoming_msg">
              <div class="incoming_msg_img"><?php if($bool==0){ ?> <img src="<?php echo base_url()?>/assets/icons/staff_profile.png" alt="subhojit"><?php }?> </div>
        ...
        <?php } ?>
          ...
          <div class="type_msg">
            ...
            <div class="input_msg_write">
              ...
              <button class="msg_send_btn" id='msg_send_btn' type="button" title="Send" onclick="sendMessage()"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
            </div>
            <?php } else { ?>
